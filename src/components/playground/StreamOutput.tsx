  ...
  return (
    <div className="rounded-xl border border-neutral-800 overflow-hidden flex flex-col">
      ...
      <div className="flex items-center justify-between px-4 py-2 bg-neutral-900 border-b border-neutral-800">
        <span className="text-xs uppercase tracking-widest text-neutral-500">Output</span>
        <div className="flex items-center gap-2">
          ...
          {!streaming && output && (
            <>
              ...
              <Button onClick={onReset} variant="ghost" size="sm" aria-label="Clear output">
                Clear
              </Button>
            </>
          )}
      ...
      <div
        ...
        aria-atomic="false"
        className="flex-1 p-4 min-h-[180px] max-h-[420px] overflow-y-auto font-mono text-[13px] leading-relaxed text-neutral-300 whitespace-pre-wrap break-words"
      >
        {isEmpty ? (
